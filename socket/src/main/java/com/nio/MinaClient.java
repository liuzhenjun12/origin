...
public class MinaClient {
	...
	public static void main(String[] args) {
		System.out.println(new MinaClient().startClient(new InetSocketAddress("127.0.0.1", 8087), 5000, "<?xml version=\"1.0\" encoding=\"UTF-8\"?><root><code>1000</code><sn>LockStatus</sn></root>", "hello"));
	}
}